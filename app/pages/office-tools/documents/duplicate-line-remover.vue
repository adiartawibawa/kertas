...
const slug = 'duplicate-line-remover'
...
<template>
  <div>
    ...
    <div class="mt-5 flex flex-wrap gap-x-6 gap-y-3 rounded-md border border-slate-200 bg-white p-4">
      <OptionToggle v-model="options.caseSensitive" :label="tp('optionCaseSensitive')" />
    ...
    <div class="mt-4 flex flex-wrap items-center gap-3">
      ...
      <span class="text-sm text-ink-soft">{{ tp('duplicatesRemovedLabel', { count: duplicatesRemoved }) }}</span>
    </div>
