...
<template>
  <div>
    <section class="pt-14 sm:pt-20">
      <h1
        class="max-w-[24ch] text-4xl font-semibold leading-tight text-ink sm:text-5xl bg-clip-text text-transparent bg-gradient-to-tr from-accent-dark via-emerald-600 to-accent">
        {{ t('home.title') }}
      </h1>
