    ...
    <div class="mt-5 rounded-md border border-slate-200 bg-white p-6">
      <template v-if="mode === 'count'">
        ...
        <div class="mt-6 border-t border-slate-200 pt-5">
          <p class="text-xs font-medium uppercase tracking-wide text-ink-soft">{{ tp('businessDaysCountLabel') }}</p>
      ...
      <template v-else>
        ...
        <div class="mt-6 border-t border-slate-200 pt-5">
          <p class="text-xs font-medium uppercase tracking-wide text-ink-soft">{{ tp('resultDateLabel') }}</p>
          <p class="mt-1 font-mono text-3xl font-medium text-accent-dark">
            {{ resultDate ?? '—' }}
          </p>
        </div>
