...
const categorySlug = 'spreadsheet'
  ...
  script: [
    {
      ...
      innerHTML: JSON.stringify({
        ...
        hasPart: toolSlugs.map((slug) => ({
          ...
          url: `${siteUrl}/office-tools/spreadsheet/${slug}`,
        })),
      }),
    },
    {
      ...
      innerHTML: JSON.stringify({
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 2, name: 'Office Tools', item: `${siteUrl}/office-tools` },
          {
            ...
            position: 3,
            name: categoryName(),
            item: `${siteUrl}/office-tools/spreadsheet`,
          },
        ],
      }),
    },
  ...
  <div>
    ...
    <section class="mt-10 grid gap-4 pb-16">
      <article v-for="slug in toolSlugs" :key="slug"
        ...
        <NuxtLinkLocale :to="`/office-tools/spreadsheet/${slug}`"
